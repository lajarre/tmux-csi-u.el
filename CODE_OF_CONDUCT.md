...
standards of acceptable behavior and will take fair, proportionate action in
...
Examples of representing the project include using an official email
address, posting via an official social media account, or acting as an
appointed representative at an online or offline event.

## enforcement

Report Code of Conduct incidents through one of these repo-local paths:

- <https://github.com/lajarre/tmux-emacs-csi-u/issues/new?template=conduct-report.md>
- <mailto:lajarre@proton.me>

The GitHub issue path is public. For private reports, use `lajarre@proton.me`.
