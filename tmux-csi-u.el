...
(define-obsolete-function-alias
  ...
  "0.1.0")
(define-obsolete-function-alias
  'tmux-emacs-csi-u--set-auto-enable
  'tmux-csi-u--set-auto-enable
  "0.1.0")
(define-obsolete-function-alias
  'tmux-emacs-csi-u--sync-tty-setup-hook
  'tmux-csi-u--sync-tty-setup-hook
  "0.1.0")
(define-obsolete-function-alias
  ...
  "0.1.0")
(define-obsolete-function-alias
  'tmux-emacs-csi-u--support-signal
  'tmux-csi-u--support-signal
  "0.1.0")
(define-obsolete-function-alias
  'tmux-emacs-csi-u--support-state
  'tmux-csi-u--support-state
  "0.1.0")
(define-obsolete-function-alias
  'tmux-emacs-csi-u--annotate-report-with-support-state
  'tmux-csi-u--annotate-report-with-support-state
  "0.1.0")
(define-obsolete-function-alias
  'tmux-emacs-csi-u--render-report
  'tmux-csi-u--render-report
  "0.1.0")
(define-obsolete-function-alias
  'tmux-emacs-csi-u--candidate-table
  'tmux-csi-u--candidate-table
  "0.1.0")
(define-obsolete-function-alias
  'tmux-emacs-csi-u--owned-bindings
  'tmux-csi-u--owned-bindings
  "0.1.0")
(define-obsolete-function-alias
  'tmux-emacs-csi-u--owned-bindings-cache
  'tmux-csi-u--owned-bindings-cache
  "0.1.0")
(define-obsolete-function-alias
  ...
  "0.1.0")
(define-obsolete-function-alias
  'tmux-emacs-csi-u--frame-input-decode-map
  'tmux-csi-u--frame-input-decode-map
  "0.1.0")
(provide 'tmux-csi-u)
